      ...
      <Link href={getProductPath(slug)} className="absolute inset-0">
        {cover?.src ? (
          <>
            ...
            />
            <div
              className={`pointer-events-none absolute inset-0 bg-gradient-to-t from-boutique-ink/35 via-transparent to-transparent transition-opacity duration-500 ease-out group-hover:opacity-90 motion-reduce:transition-none ${
