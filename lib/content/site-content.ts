...
export const siteContentDefaults = {
  ...
  "privacy.hero_description":
    "Използваме само информацията, необходима за поръчки, записвания и комуникация.",
  "privacy.updated_at": "Последна актуализация: 28 май 2026 г.",
  ...
  "cookies.hero_description":
    "Какви технически механизми използва магазинът и защо са необходими.",
  "cookies.updated_at": "Последна актуализация: 28 май 2026 г.",
  "cookies.what_title": "Какво са бисквитките",
  "cookies.what_text":
    "Бисквитките и сходните технологии са малки записи в браузъра, които помагат на сайта да работи правилно и да запази необходимото състояние.",
  "cookies.usage_title": "Какво използва магазинът",
  "cookies.usage_text":
    "В момента се използват технически необходими механизми, включително за администраторска сесия, сигурност и запазване на количката в браузъра.",
  "cookies.analytics_title": "Аналитика и реклама",
  "cookies.analytics_text":
    "Към момента не са активирани рекламни или аналитични бисквитки като Meta Pixel или Google Analytics. Преди включването им тази политика и управлението на съгласието ще бъдат актуализирани.",
