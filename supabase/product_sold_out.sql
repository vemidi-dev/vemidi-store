-- Sold-out flag for products (no stock quantities).
-- Run after product_wish_assignments.sql and product_promotions.sql.
...
-- Checkout must reject sold-out products even if the client cart still contains them.
