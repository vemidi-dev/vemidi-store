-- Product upsell checkout pricing.
-- Run after product_upsell_offers.sql and after the latest create_store_order checkout migration.
-- Keeps checkout server-side pricing authoritative for upsell-only and discounted upsell lines.
